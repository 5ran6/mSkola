...
import mountedwings.org.mskola_mgt.adapter.NumbersChatCategories;
...
public class ChatCategoriesActivity extends AppCompatActivity {
    private View back_drop;
    private boolean rotate = false;
    private View lyt_hols;
    private View lyt_save;
    public CheckBox all_morning, all_afternoon;
    ArrayList<NumberChatCategory> numbers;
            ...
            if (!text.isEmpty() && !text.equals("0")) {
                ...
                if (rows.length > 0) {
                    for (int i = 0; i < rows.length; i++) {
                        ...
                        NumberChatCategory number = new NumberChatCategory();
                        ...
                        try {
                            ...
                            //checked afternoon
                            if (afternoon[i].trim().equals("1")) number.setSelected(true);
                        } catch (Exception ex) {
                            ex.printStackTrace();
                        }
                        numbers.add(number);
                    ...
                    adapter = new NumbersChatCategories(numbers);
