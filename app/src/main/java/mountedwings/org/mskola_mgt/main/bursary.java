 ...
 */
public class bursary extends Fragment {
    public bursary() {
    ...
    public static bursary newInstance(int instance) {
        Bundle args = new Bundle();
        args.putInt("argsInstance", instance);
        bursary bursary = new bursary();
        bursary.setArguments(args);
        return bursary;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_social_hub, container, false);
        // Inflate the layout for this fragment
        Objects.requireNonNull(getActivity()).setTitle(getString(R.string.social_hub));
        return view;
    }
