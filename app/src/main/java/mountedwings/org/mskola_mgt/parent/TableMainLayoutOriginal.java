...
public class TableMainLayoutOriginal extends RelativeLayout {
    ...
    List<SampleObjectOriginal> sampleObjects = this.sampleObjects();

    int headerCellsWidth[] = new int[headers.length];

    public TableMainLayoutOriginal(Context context) {
    ...
    List<SampleObjectOriginal> sampleObjects() {

        List<SampleObjectOriginal> sampleObjects = new ArrayList<SampleObjectOriginal>();

        for (int x = 1; x <= 20; x++) {

            SampleObjectOriginal sampleObject = new SampleObjectOriginal(
                    "Col 1, Row " + x,
    ...
    private void generateTableC_AndTable_B() {
        ...
        for (SampleObjectOriginal sampleObject : this.sampleObjects) {
    ...
    TableRow tableRowForTableC(SampleObjectOriginal sampleObject) {
    ...
    TableRow taleRowForTableD(SampleObjectOriginal sampleObject) {
